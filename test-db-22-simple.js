// Test with 22 products - simplified Balsamiq
const testDB = [
...
{id:22,name:"Balsamiq",category:"pmtools",icon:"✏️",url:"https://balsamiq.com",users:"数百万",pricing:"$9/$12 mo",rating:8.7,hot:false,founded:"2008",team:"Balsamiq Studios 30+",funding:"Bootstrapped",desc:"快速低保真原型工具手绘风格界面让沟通聚焦逻辑而非视觉",position:"低保真线框图工具 - 快速表达想法促进早期沟通的轻量级原型工具",targetUsers:"产品经理创业者UX设计师业务分析师咨询顾问",valueProp:"Sketch UI ideas fast - 秒速画出想法让讨论回归本质",features:{primary:["Drag-and-Drop Interface","Hand-Drawn Style","Pre-built UI Library","Linking to Mockups","Export to PDF/PNG"],secondary:["Collaboration Cloud","Comments","Symbols"]},businessModel:{freemium:"30天试用",subscription:"Cloud $9/mo Desktop $12/mo",enterprise:"Team License折扣"},pmAnalysis:{successReason:["1. 学习成本极低","2. 手绘风格巧妙","3. 价格亲民","4. 聚焦沟通","5. 轻量快速"],moat:["1. 手绘风格独特性","2. 轻量定位差异化","3. 用户心智占领","4. 盈利模式健康","5. 忠诚用户群体"],growthFlywheel:["用户快速画草图→展示给团队→获得反馈→快速迭代→验证想法→推荐给同事"]}}
];
